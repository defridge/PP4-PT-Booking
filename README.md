...
There was some errors found with the form generated by Django's allauth signup page, but as I didnt create this code or am unable to update it the errors can still be found.
